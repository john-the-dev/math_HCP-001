...
The bounded experiment now reaches radius 12. Radius 12 logically subsumes
radii 1--11: these are one nested exclusion checked at twelve bounds, not twelve
independent assurances. The result rests on the radius-12 proof together with
...
5--12 used binary DRAT. CaDiCaL proof traces are not canonical: proof format,
