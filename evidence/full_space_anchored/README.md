...
`python-sat 1.9.dev15`) were medians of five runs:

| case | core clauses | total clauses | encoded variables | build seconds |
| --- | ---: | ---: | ---: | ---: |
| d18-j0-k10 | 757,381 | 2,458,717 | 373,243 | 0.343 |
| d18-j0-k13 | 757,381 | 2,458,717 | 373,243 | 0.307 |
| d19-j1-k9 | 746,017 | 2,447,353 | 368,002 | 0.294 |
| d19-j1-k13 | 746,017 | 2,447,353 | 368,002 | 0.320 |
| d20-j2-k8 | 742,567 | 2,443,903 | 366,689 | 0.368 |
| d20-j2-k13 | 742,567 | 2,443,903 | 366,689 | 0.344 |
